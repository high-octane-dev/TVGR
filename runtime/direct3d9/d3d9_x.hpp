...
enum XD3DFillMode {
    XD3DFILL_POINT = 0x01,
    XD3DFILL_WIREFRAME = 0x25,
    XD3DFILL_SOLID = 0x00,
    XD3DFILL_FORCE_DWORD = 0x7fffffff,
};
...
enum XD3DCull {
    ...
    XD3DCULL_CW = 0x2,
    XD3DCULL_CCW = 0x6,
    XD3DCULL_FORCE_DWORD = 0x7fffffff,
};

enum XD3DBlend {
    XD3DBLEND_ZERO = 0,
    XD3DBLEND_ONE = 1,
    XD3DBLEND_SRCCOLOR = 4,
    XD3DBLEND_INVSRCCOLOR = 5,
    XD3DBLEND_SRCALPHA = 6,
    XD3DBLEND_INVSRCALPHA = 7,
    XD3DBLEND_DESTCOLOR = 8,
    XD3DBLEND_INVDESTCOLOR = 9,
    XD3DBLEND_DESTALPHA = 10,
    XD3DBLEND_INVDESTALPHA = 11,
    XD3DBLEND_BLENDFACTOR = 12,
    XD3DBLEND_INVBLENDFACTOR = 13,
    XD3DBLEND_CONSTANTALPHA = 14,
    XD3DBLEND_INVCONSTANTALPHA = 15,
    XD3DBLEND_SRCALPHASAT = 16,
    XD3DBLEND_FORCE_DWORD = 0x7fffffff,
};

enum XD3DBlendOperation {
    XD3DBLENDOP_ADD = 0,
    XD3DBLENDOP_SUBTRACT = 1,
    XD3DBLENDOP_MIN = 2,
    XD3DBLENDOP_MAX = 3,
    XD3DBLENDOP_REVSUBTRACT = 4,
    XD3DBLENDOP_FORCE_DWORD = 0x7fffffff,
};

enum XD3DStencilOperation {
    XD3DSTENCILOP_KEEP = 0,
    XD3DSTENCILOP_ZERO = 1,
    XD3DSTENCILOP_REPLACE = 2,
    XD3DSTENCILOP_INCRSAT = 3,
    XD3DSTENCILOP_DECRSAT = 4,
    XD3DSTENCILOP_INVERT = 5,
    XD3DSTENCILOP_INCR = 6,
    XD3DSTENCILOP_DECR = 7,
    XD3DSTENCILOP_FORCE_DWORD = 0x7fffffff,
};

enum XD3DTextureAddress {
    XD3DTADDRESS_WRAP = 0,
    XD3DTADDRESS_MIRROR = 1,
    XD3DTADDRESS_CLAMP = 2,
    XD3DTADDRESS_MIRRORONCE = 3,
    XD3DTADDRESS_BORDER_HALF = 4,
    XD3DTADDRESS_MIRRORONCE_BORDER_HALF = 5,
    XD3DTADDRESS_BORDER = 6,
    XD3DTADDRESS_MIRRORONCE_BORDER = 7,
    XD3DTADDRESS_FORCE_DWORD = 0x7fffffff,
};

enum XD3DTextureFilterType {
    XD3DTEXF_POINT = 0,
    XD3DTEXF_LINEAR = 1,
    XD3DTEXF_NONE = 2,
    XD3DTEXF_ANISOTROPIC = 4,
    XD3DTEXF_FORCE_DWORD = 0x7fffffff,
};

enum XD3DComparisonFunction {
    XD3DCMP_NEVER = 0,
    XD3DCMP_LESS = 1,
    XD3DCMP_EQUAL = 2,
    XD3DCMP_LESSEQUAL = 3,
    XD3DCMP_GREATER = 4,
    XD3DCMP_NOTEQUAL = 5,
    XD3DCMP_GREATEREQUAL = 6,
    XD3DCMP_ALWAYS = 7,
    XD3DCMP_FORCE_DWORD = 0x7fffffff,
};
